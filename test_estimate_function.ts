// Test script to verify the estimate function loads without syntax errors
...
console.log('Testing estimate function import...')

// Import the function (this will catch syntax errors)
try {
  await import('./supabase/functions/estimate.ts')
  console.log('✅ Estimate function loaded successfully')
} catch (error) {
  console.error('❌ Estimate function failed to load:', error)
  Deno.exit(1)
}
