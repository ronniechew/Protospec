            ...
            <div v-if="filteredQuotes.length > 0" class="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div class="flex items-center space-x-2">
                <button
                  ...
                  class="px-3 py-2 rounded-md text-body-medium font-medium text-text-secondary bg-bg-primary border border-border-color hover:bg-bg-secondary disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Previous
                </button>
